...
See [`AGENTS.md`](./AGENTS.md) for the full project/architecture/conventions guide (kept tool-agnostic so other coding agents can read it too) — this file exists only as the Claude Code entry point.

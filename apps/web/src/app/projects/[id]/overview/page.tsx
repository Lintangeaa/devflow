      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-2xl border bg-background p-4 shadow-soft">
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 flex items-center gap-1.5 text-xs text-muted-foreground">
              <span>{(data.bugs.byStatus.new ?? 0) + (data.bugs.byStatus.open ?? 0)} terbuka</span>
              <span>•</span>
        ...
        <div className="rounded-2xl border bg-background p-4 shadow-soft">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-muted-foreground">Production Tickets</span>
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 flex items-center gap-1.5 text-xs text-muted-foreground">
              <span>{(data.productionBugs.byStatus.new ?? 0) + (data.productionBugs.byStatus.open ?? 0)} terbuka</span>
              <span>•</span>
              <span>{data.productionBugs.byStatus.in_progress ?? 0} in progress</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-2xl border bg-background p-4 shadow-soft">
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 text-xs text-muted-foreground">
              Tiket aktif di seluruh kategori
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border bg-background p-5 shadow-soft">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-sm">Status Task (Board)</h3>
              <p className="text-xs text-muted-foreground">Distribusi status pengerjaan task</p>
            </div>
        ...
        <div className="rounded-2xl border bg-background p-5 shadow-soft">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-sm">Status Bugs (Pre-Prod)</h3>
              <p className="text-xs text-muted-foreground">Triage status bug sebelum rilis</p>
            </div>
                  ...
                  <div className="flex items-center gap-1.5">
                    {ticket.assigneeName ? (
                      <>
                        ...
                        <span className="truncate max-w-[120px]">{ticket.assigneeName}</span>
                      </>
                    ) : (
                      <span className="italic">Tanpa Assignee</span>
                    )}
                  </div>
                  {ticket.phaseName && (
